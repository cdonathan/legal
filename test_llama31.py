...
def test_llama31_pii_detection(text):
    """Test llama3.1:8b for PII detection"""
...
print(f"Testing llama3.1:8b with 1000-character chunk...")
print(f"Chunk length: {len(test_chunk)} characters")
print(f"Sample: {test_chunk[:100]}...")

duration, result = test_llama31_pii_detection(test_chunk)
